  ...
  const teamMembers = [
    {
      ...
      subtitle:
        "#1 International Bestselling Author, Executive Producer & Host - Mindset Mastery Moments Podcast (Top 1% Worldwide)",
    ...
    },
    {
      ...
      subtitle: "",
      position:
        "[Project Lead for Menstrual Health and Hygiene, Winetoya Rural Child Foundation]",
    },
  ];
