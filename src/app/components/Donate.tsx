...
export const Donate: FC = () => {
  const [donationMode, setDonationMode] = useState<'once' | 'monthly'>('monthly');
  ...
  const handleDonate = () => {
    if (selectedAmount) {
      ...
      // console.log(`Donating $${selectedAmount} ${donationMode === 'once' ? 'once' : 'monthly'}`);
  ...
  return (
    <>
      <div className="py-8 px-4 max-w-lg mx-auto">
        {/* Tabs */}
        <div className="flex bg-white rounded-lg justify-center space-x- mb-6 w-full">
          <button
