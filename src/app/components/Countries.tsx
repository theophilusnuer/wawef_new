...
const countries: CountryOption[] = [
  ...
  { name: "Comoros", code: "KM" }, { name: "Congo (Congo-Brazzaville)", code: "CG" }, { name: "Costa Rica", code: "CR" },
  { name: "Croatia", code: "HR" }, { name: "Cuba", code: "CU" }, { name: "Cyprus", code: "CY" },
  { name: "Czechia (Czech Republic)", code: "CZ" }, { name: "Denmark", code: "DK" }, { name: "Djibouti", code: "DJ" },
  ...
  { name: "Myanmar (Burma)", code: "MM" }, { name: "Namibia", code: "NA" }, { name: "Nauru", code: "NR" },
...
export const CountrySelect: React.FC<CountrySelectProps> = ({ value, onChange, required = false }) => {
  return (
    <div>
      <label htmlFor="country" className="block text-sm md:text-base mb-1">
        Country
      </label>
      <select
        id="country"
...
export { countries }; // Export the countries array for use in other files