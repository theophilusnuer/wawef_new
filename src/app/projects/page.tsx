  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore WAWEF's flagship and completed projects empowering women and communities across West Africa."
        />
      </Head>
      ...
      <div className="relative w-full h-[50vh] sm:h-[60vh] overflow-hidden">
        <Image
          src={pad3.src}
          alt="WAWEF Flagship Projects Hero"
          fill
        ...
        <div className="relative z-10 flex flex-col justify-end h-full pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 md:px-10 lg:px-16">
          <div className="max-w-6xl mx-auto w-full text-center">
            <h1 className="text-3xl sm:text-5xl text-white font-bold tracking-tight drop-shadow-lg">
              Our Flagship Projects
            </h1>
            <p className="text-white text-base sm:text-xl italic my-3">
              Explore our ongoing and completed projects making a lasting
              impact.
            </p>
          </div>
        </div>
