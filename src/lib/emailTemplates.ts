export const emailTemplates = {
  ...
  donation: {
    ...
    text: `Dear {firstName},\n\nThank you for your generous donation to the West Africa Women Empowerment Foundation (WAWEF). Your support helps empower women and girls in West Africa.\n\nBest regards,\nThe WAWEF Team`,
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; background-color: #fff; padding: 25px;">
        <div style="max-width: 600px; margin: auto; background-color: #fffef5; border-radius: 10px; overflow: hidden;">
          <div style="background-color: #F2C94C; padding: 20px; text-align: center;">
          ...
          <div style="padding: 30px; font-size: 14px;">
            ...
            <p style="line-height: 1.6; color: #333;">
              Thank you for your generous donation to the West Africa Women Empowerment Foundation (WAWEF).
            </p>
            <p style="line-height: 1.6; color: #333;">
              Your support helps empower women and girls in West Africa. We truly appreciate your contribution.
            </p>
            <p style="line-height: 1.6; color: #333;">
  ...
  sponsorship: {
    ...
    text: `Dear {firstName},\n\nThank you for sponsoring a program with the West Africa Women Empowerment Foundation (WAWEF). Your contribution makes a significant impact.\n\nBest regards,\nThe WAWEF Team`,
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; background-color: #fff; padding: 25px;">
        <div style="max-width: 600px; margin: auto; background-color: #fffef5; border-radius: 10px; overflow: hidden;">
          <div style="background-color: #F2C94C; padding: 20px; text-align: center;">
          ...
          <div style="padding: 30px; font-size: 14px;">
            <h4 style="color: #000;">Dear {firstName},</h4>
            <p style="line-height: 1.6; color: #333;">
              Thank you for sponsoring a program with the West Africa Women Empowerment Foundation (WAWEF).
            </p>
            <p style="line-height: 1.6; color: #333;">
              Your contribution makes a significant impact, and we are grateful for your support.
            </p>
            <p style="line-height: 1.6; color: #333;">
              Best regards,<br />The WAWEF Team
            </p>
