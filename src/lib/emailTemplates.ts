export const emailTemplates = {
      ...
      <div style="font-family: Arial, sans-serif; color: #333; background-color: #fff; padding: 25px;">
        <div style="max-width: 600px; margin: auto; background-color: #fffef5; border-radius: 10px; overflow: hidden;">
          ...
          <div style="padding: 20px; text-align: center; background-color: #fff; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
            ...
            <p style="font-size: 12px; color: #999;">&copy; ${new Date().getFullYear()} WAWEF. All rights reserved.</p>
            <p style="line-height: 1.6; color: #888; font-size: 10px;">
              <a href="https://wawef.org/api/newsletter?email={email}&action=unsubscribe" style="color: #F2C94C; text-decoration: none;">
                Unsubscribe
              </a>
            </p>
          </div>
  ...
  // Add donation and sponsorship templates later as needed
  donation: {
